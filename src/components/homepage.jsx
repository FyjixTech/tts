    ...
    return (
        <div className='homepage'>
            ...
            <div className="container">
                ...
                <div className="row center mt-4 mb-5">
                    <div className="col">
                    <span className='btn button2'>Choose Plan</span>
                    </div>
                </div>
            </div>
                        ...
                        <center>
                            ...
                            <div className="row center">
                                <div className="col center mt-3">
                                    <span className='btn button2' style={{width:"250px"}}><h4>Try Free Demo</h4></span>
                                </div>
                                <div className="col center mt-3">
                                    <span className='btn button3'><h4>Sign Up</h4></span>
                                </div>
                            </div>
                        </center>
                    </div>
